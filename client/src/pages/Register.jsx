            ...
            >
                <div className={clsx(
                    ...
                    <div className="text-center mb-10">
                        <div className={clsx(
                            "w-20 h-20 bg-primary-600 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-2xl relative group"
                        )}>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className={clsx(
                                "w-full bg-primary-600 text-white font-black py-5 rounded-[1.5rem] hover:bg-primary-700 transition-all duration-300 shadow-2xl shadow-primary-500/30 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed text-lg flex items-center justify-center gap-3 mt-4"
                            )}
                        >
                            {loading ? (
