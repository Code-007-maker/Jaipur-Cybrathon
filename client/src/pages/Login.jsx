...
const Login = () => {
    ...
    return (
        <div className={clsx(
            ...
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                ...
                <motion.div
                    ...
                    className={clsx(
                        ...
                        isDarkMode ? "bg-teal-900" : "bg-teal-200"
                    )}
                />
            </div>
            ...
            >
                <div className={clsx(
                    "relative w-full h-full p-8 rounded-[2.5rem] overflow-hidden transition-all duration-300",
                    isDarkMode
                        ? "bg-slate-900 border border-primary-500/30 shadow-[0_0_30px_rgba(20,184,166,0.15)]"
                        : "bg-white/95 border border-primary-200/50 shadow-[0_0_30px_rgba(20,184,166,0.25)]"
                )}>
                    {/* Header */}
                    ...
                    <div className={clsx(
                        ...
                        isDarkMode ? "bg-slate-800/50 border-slate-700/50" : "bg-slate-100/50 border-slate-200"
                    )}>
                        <button
                            ...
                            className={clsx(
                                ...
                                loginMode === 'patient'
                                    ...
                                    : isDarkMode ? "text-slate-400" : "text-slate-500 hover:text-slate-700"
                            )}
                        >
                            ...
                            {loginMode === 'patient' ? (
                                        ...
                                        <div className="relative group">
                                            ...
                                            <input
                                                ...
                                                className={clsx(
                                                    ...
                                                    isDarkMode
                                                        ? "bg-slate-800/50 border-slate-700 text-white placeholder-slate-500 focus:border-primary-500 focus:bg-slate-800"
                                                        : "bg-white border-slate-100 text-slate-900 placeholder-slate-400 focus:border-primary-500 focus:shadow-xl focus:shadow-primary-100"
                                                )}
                                ...
                                >
                                    <div className={clsx(
                                        ...
                                        isDarkMode ? "bg-primary-500/10 text-primary-400" : "bg-primary-50 text-primary-700"
                                    )}>
                                    ...
                                    <div className="space-y-2 text-left">
                                        ...
                                        <div className="relative group">
                                            <KeyRound className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within:text-primary-500 transition-colors" />
                                            <input
                                                type="text"
                                                maxLength="6"
                                                placeholder="000000"
                                                className={clsx(
                                                    ...
                                                    isDarkMode
                                                        ? "bg-slate-800/50 border-slate-700 text-white placeholder-slate-700 focus:border-primary-500 focus:bg-slate-800"
                                                        : "bg-white border-slate-100 text-slate-900 placeholder-slate-200 focus:border-primary-500 focus:shadow-xl focus:shadow-primary-100"
                                                )}
                                                value={formData.otp}
